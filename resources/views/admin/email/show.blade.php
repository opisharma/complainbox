                        ...
                        <div class="box box-widget">
                            ...
                            <div class="box-footer">
                                <p><strong>Application status:</strong> </p>
                                    @if ($mail->status === NULL)
                                        <a href="{{ route('admin.approve',$mail->id) }}"><button class="btn bg-green flat-btn btn-sm text-white"><i class="lni lni-checkmark-circle"></i>Approve</button></a>
                                        <a href="{{ route('admin.decline',$mail->id) }}"><button class="btn bg-red flat-btn btn-sm text-white"><i class="bx bx-shield-x"></i>Decline</button></a>
                                    @else
                                        @if($mail->status == 1) 
